...
export default function MusicModule({ isHost, sync, onControl, onAckSync }: MusicModuleProps) {
      ...
      {isHost ? (
        <div className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-[1fr_auto]">
            ...
            <button className="rounded-xl border border-border px-4 py-3 font-semibold text-text transition hover:bg-white/5" onClick={() => onControl(sync.paused ? 'play' : 'pause', {
